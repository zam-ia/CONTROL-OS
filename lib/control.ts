...
export function seed(): State {
  ...
  const onboardingLessons: Lesson[] = [
    ...
    [
      ...
      'CHECKLIST',
      'Checklist de navegación completado.',
    ],
    [
      '00.4',
      'Define tu objetivo de 90 días',
      'Convierte tu intención general en un resultado concreto y medible.',
      'Elegir un objetivo principal para los próximos 90 días.',
      'Registrar el resultado, la fecha y el número que confirmará el avance.',
      'PLANTILLA',
      'Objetivo de 90 días registrado.',
    ],
    [
      '00.5',
      'Completa tu CONTROL Score inicial',
      'Evalúa con honestidad las áreas que hoy sostienen o frenan al negocio.',
      'Crear una fotografía sencilla de tu punto de partida.',
      'Completar todas las preguntas del diagnóstico.',
      'DIAGNOSTICO',
      'CONTROL Score inicial generado.',
    ],
    [
      '00.6',
      'Detecta tu primera fuga o cuello de botella',
      'Usa el diagnóstico para encontrar un problema que hoy consume dinero, tiempo o energía.',
      'Elegir un problema concreto que puedas observar y explicar.',
      'Describir qué ocurre, dónde ocurre y qué consecuencia produce.',
      'FORMULARIO',
      'Primera fuga o cuello de botella documentado.',
    ],
    [
      '00.7',
      'Publica tu punto de partida',
      'Resume lo que creías, lo que encontraste y qué vas a cambiar primero.',
      'Compartir un descubrimiento útil sin exponer datos confidenciales.',
      'Escribir y enviar tu reflexión al mentor.',
      'COMUNIDAD',
      'Punto de partida compartido para recibir feedback.',
    ],
    [
      '00.8',
      'Activa tu plan de las primeras 72 horas',
      'Ordena las primeras acciones y prepara la conversación de inicio con tu mentor.',
      'Salir con un responsable, una fecha y el siguiente paso visible.',
      'Confirmar tus tres primeras acciones y agendar el kickoff.',
      'CHECKLIST',
      'Plan inicial activado y sesión de kickoff preparada.',
    ],
  ].map(
    (
      ...
      due: date(index + 1),
      points: 10,
      requiresReview: index >= 3,
      requiredForUnlock: true,
      owner: index === 4 ? 'A' : index >= 3 ? 'C+E' : 'C',
      minAccess: 'LOW',
    }),
  );
