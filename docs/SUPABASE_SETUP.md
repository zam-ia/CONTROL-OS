...
La décima migración corrige el perfil de la identidad interna `admin@crisdalcompany.com` para que tenga el rol `SUPER_ADMIN` activo. Es segura para volver a ejecutar y evita que la interfaz administrativa y los permisos del servidor queden desalineados.
